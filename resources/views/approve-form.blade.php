            ...
            <div class="col-12 col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-8 offset-lg-2 col-xl-8 offset-xl-2">
                <div class="card card-primary mt-4">
                    <div class="card-header d-flex justify-content-between">
                        <h4>Complete the Below Form to Approve this Request</h4>
                        ...
                        <form method="POST" action="{{route('comments.approve')}}" id="approveForm">
                            ...
                            <div class="row">
                                <div class="form-group col-12">
                                    <label for="defer_start_date">Approve Start Date:</label>
                            ...
                            <div class="row">
                                <div class="form-group col-12">
                                    <label for="defer_end_date">Approve End Date:</label>
